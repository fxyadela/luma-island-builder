...
description: "引导用户通过对话创建、原型化、实现、安装或升级一个跨平台光岛 / Luma Island：桌面工作岛、浮岛、Island 风格任务入口或桌面快捷执行面板。适用于快速链接、资料复制、模板回复、待办、状态面板、本地脚本、AI 提示词等高频动作。用户提到光岛、Luma Island、桌面工作岛、Island、desktop island、生产力桌面助手、快捷任务中心，或想把个人桌面助手想法做成可运行、可安装、下次能找到入口的桌面应用时使用。也用于已安装旧版光岛项目的样式升级、CSS 更新、保留配置升级、迁移旧项目样式。不要用于纯装饰桌宠。"
---
